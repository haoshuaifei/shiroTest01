...
public class TestMyRealm {
    public static void main(String[] args) {
        ...
        Factory<org.apache.shiro.mgt.SecurityManager> factory = new IniSecurityManagerFactory("classpath:shiro_myRealm.ini");
        ...
        //使用有某个权限
        boolean b_p=subject.isPermitted("user:abc");
        System.out.println("是否有某一个权限"+b_p);
        boolean b_ps=subject.isPermittedAll("user:select","user:update");
        System.out.println("是否有某几个权限"+b_ps);
        //退出
